...
export const MAP_LOCATION_SEED: Omit<MapLocation, "sandtableRegionId" | "sandtableZoneId">[] = [
  // —— 建设主体（10） ——
  {
    ...
    relatedTaskSlugs: ["confirm_project_need"],
  ...
  },
  {
    ...
    unlockStage: "INITIATION",
    relatedTaskSlugs: ["prepare_master_control_plan", "hidden_acceptance_missing"],
  ...
  },
  {
    ...
    relatedTaskSlugs: ["prepare_bidding_plan", "sign_construction_contract"],
    relatedNpcNames: ["甲方代表"],
  ...
  },
  {
    ...
    unlockStage: "PROCUREMENT",
    relatedTaskSlugs: ["prepare_tender_document", "issue_bid_winning_notice", "prepare_bidding_plan", "sign_supervision_contract", "sign_construction_contract"],
  ...
  },
  {
    ...
    relatedTaskSlugs: ["sign_construction_contract", "supervisor_reject_close"],
  ...
  },
  {
    ...
    relatedTaskSlugs: ["opening_joint_inspection", "merchant_early_entry", "property_key_handover"],
  ...
  // —— 政府单位 ——
  {
    ...
    relatedTaskSlugs: ["commission_project_proposal", "prepare_approval_application_package", "submit_approval_application", "obtain_approval_reply"],
    riskTags: ["approval"],
  ...
  },
  {
    ...
    unlockStage: "APPROVAL",
    unlockMilestones: ["approvalPathConfirmed"],
    relatedTaskSlugs: ["consult_planning_condition", "obtain_land_pre_review_opinion"],
  ...
  },
  {
    ...
    relatedTaskSlugs: ["fire_pump_sign_missing"],
  ...
  },
  {
    ...
    relatedTaskSlugs: ["property_key_handover", "opening_joint_inspection"],
