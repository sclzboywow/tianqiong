...
export function InkStoryViewer({ lines, choices, onChoose, loading, result }: InkStoryViewerProps) {
      ...
      {result && (
        <Card className="border-amber-700 bg-zinc-900">
          ...
          <CardContent className="space-y-2 text-sm text-zinc-300">
            <p>经验 +{result.rewards.exp} · 金币 +{result.rewards.gold} · 声望 +{result.rewards.reputation}</p>
            <div>
